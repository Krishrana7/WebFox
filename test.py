...
def banner():
    # Added 'r' before """ to fix the SyntaxWarning
    print(Fore.CYAN + Style.BRIGHT + r"""
 _    _  _____ ______ ______ _____  __   __
| |  | ||  ___|| ___ \|  ___||  _  | \ \ / /
| |  | || |__  | |_/ /| |_   | | | |  \ V / 
| |/\| ||  __| | ___ \|  __| | | | |   /   \ 
\  /\  /| |___ | |_/ /| |    \ \_/ /  / /^\ \
 \/  \/ \____/ \____/ \_|     \___/   \/   \/
    ...
    print(Fore.YELLOW + "      Version    : " + Fore.WHITE + "1.0")
    print(Fore.YELLOW + "      Created By : " + Fore.WHITE + "Lucky")
    print(Fore.YELLOW + "      Github     : " + Fore.WHITE + "github.com/lucky-om/WebFox\n")
